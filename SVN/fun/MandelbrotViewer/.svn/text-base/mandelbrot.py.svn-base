...
class Mandelbrot:
    ...
    def configure_threads(self):
        ...
        for i in range(NUM_THREADS):
            ...
            setattr(self, name+chr(i), myThread(self.calculate,start))
...
#                    self.ppm[segment].draw_pixel((x,int(y %
#                    (self.dim/NUMBER_OF_SEGMENTS))),(r,g,b))
