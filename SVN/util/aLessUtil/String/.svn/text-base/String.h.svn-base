...
public:
  ...
  //Pre:  newChars is defined and terminated
  //Post: newChars is appended to the end of this string
  String & operator+(char * newChars);

  // Pre:  newChars is defined and properly terminated
  // Post: The characters in newChars are added to this string
  void operator+=(char * newChars);
