...
int main(int argc, char *argv[]){
  ...
  namedWindow(SETTINGS_PANEL, CV_WINDOW_NORMAL);
  ...
  namedWindow(SIFT_WINDOW,      CV_WINDOW_NORMAL);
  namedWindow(SURF_WINDOW,      CV_WINDOW_NORMAL);
  namedWindow(SOBEL_WINDOW,     CV_WINDOW_NORMAL);
